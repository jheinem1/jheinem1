...
function AcademicProjects() {
  const [openWorkoutWizard, setOpenWorkoutWizard] = useState(false);
  const [openRobotics, setOpenRobotics] = useState(false);
  ...
  return (
    <AnimatedContainer>
      ...
      <div>
        <h2
          onClick={() => setOpenWorkoutWizard(!openWorkoutWizard)}
      ...
      <div>
        <h2
          onClick={() => setOpenRobotics(!openRobotics)}
          style={{ cursor: "pointer" }}
        >
          Robotics Team
        </h2>
        {openRobotics && (
          <div>
            <p>
              I was a member of my high school robotics team (FIRST Robotics
              Team 1212) for 4 years, and was the lead programmer for 3 of those
              years. I worked closely with the hardware team to ensure the robot
              performed its tasks.
            </p>
            <iframe
              width="500"
